...
{
    for(auto sprite : renderComponents)
    {
        sprite->Draw(view);
    }
}
...
void GraphicsDevice::AddRenderComponent(RenderComponent* renderComponent)
{
    renderComponents.push_back(renderComponent);
}

void GraphicsDevice::SetView(View* v)
{
    view = v;
}
